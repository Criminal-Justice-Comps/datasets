...
- TestNumericFeatures.csv contains 10.244% of the numeric data
- ValidateNumericFeatures.csv contains 9.709% of the numeric data
- TrainNumericFeatures.csv contains 80.047% of the numeric data
