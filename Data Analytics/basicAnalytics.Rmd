...
ggplot(baseline, aes(x = truthChar, fill = correct)) + 
  geom_bar() +
  labs(title = "Random Baseline Confusion Matrix for Violent Recidivism as a Bar Graph", fill="DT Prediction", x = "Ground Truth") + 
  scale_fill_manual(values = c("#1FBFC3", "#F57670"))

ggplot(foolish, aes(x = truthChar, fill = correct)) +
  geom_bar() +
  labs(title = "Stereotypical Confusion Matrix for Violent Recidivism as a Bar Graph", fill="DT Prediction", x = "Ground Truth") + 
  scale_fill_manual(values = c("#1FBFC3", "#F57670"))
